...
* API credentials must be read from environment variables (HF\_TOKEN)  
...
Additional Guideline: [Meta OpenEnv Hackathon: Guidelines](https://docs.google.com/document/d/1nth7bAacQOQEpVk6oIHV917YuRcLOowcSS1Ed-uNQVQ/edit?tab=t.0#heading=h.6melz1m9g0d1)